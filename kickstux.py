...
class Ui_mw_anaconda(object):
    def setupUi(self, mw_anaconda):
        ...
        self.ptedt_PostListeCommandes.setToolTip("")
        ...
        self.actionOuvrir_un_fichier.setIcon(icon1)
        ...
        self.actionNouveau_fichier.setIcon(icon2)
        self.actionNouveau_fichier.setObjectName("actionNouveau_fichier")
        self.actionSauvegarder = QtWidgets.QAction(mw_anaconda)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/save.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSauvegarder.setIcon(icon3)
        ...
        self.actionQuiter.setIcon(icon4)
        self.actionQuiter.setObjectName("actionQuiter")
        self.actionSauvegarder_sous = QtWidgets.QAction(mw_anaconda)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("images/save-as-file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSauvegarder_sous.setIcon(icon5)
        ...
        self.actionA_propos.setIcon(icon6)
        self.actionA_propos.setObjectName("actionA_propos")
        self.actionpouette = QtWidgets.QAction(mw_anaconda)
        self.actionpouette.setObjectName("actionpouette")
        self.actionA_propos_de_Qt = QtWidgets.QAction(mw_anaconda)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("images/Qt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionA_propos_de_Qt.setIcon(icon7)
        ...
        self.menuA_propos.addAction(self.actionA_propos_de_Qt)
    ...
    def retranslateUi(self, mw_anaconda):
        ...
        self.cbx_langueos.setToolTip(_translate("mw_anaconda", "Choix de la langue du système."))
        ...
        self.cbx_clavier.setToolTip(_translate("mw_anaconda", "Choix du type de clavier."))
        self.cbx_fuseaux.setToolTip(_translate("mw_anaconda", "Choix du fuseau horaire ou est installée la machine."))
        ...
        self.cb_chiffrePasswd.setToolTip(_translate("mw_anaconda", "Cochez cette case pour chiffre le mot de passe dans le fichier d\'auto réponse."))
        self.cb_chiffrePasswd.setText(_translate("mw_anaconda", "Chiffrer le mot de passe."))
        self.cb_affichePasswd.setToolTip(_translate("mw_anaconda", "Affiche le mot de passe et désactive la confirmation"))
        ...
        self.edt_UrlDepot.setToolTip(_translate("mw_anaconda", "Insérer ici l\'url du dépot qui servira à l\'installation netinstall 5centos 7 et 8 uniquement)."))
        ...
        self.ptedt_PreListeCommandes.setToolTip(_translate("mw_anaconda", "Inserez ici vos commandes de pré installation sans les balises %pre ou % end"))
        self.ptedt_PreListeCommandes.setPlaceholderText(_translate("mw_anaconda", "Inserez ici vos commandes de pré installation sans les balises %post ou % end"))
        self.edt_PreInstall.setToolTip(_translate("mw_anaconda", "Inserez ici le chemin vers votre interpréteur"))
        ...
        self.cb_PreEpel.setToolTip(_translate("mw_anaconda", "Ne fonctionne qu\'avec l\'interpréteur bash et centos 7 ou 8. La commande sera ajoutée lors de la création du fichier."))
        self.cb_PreEpel.setText(_translate("mw_anaconda", "Installer le dépot EPEL."))
        self.cb_PreRpmFusion.setToolTip(_translate("mw_anaconda", "Ne fonctionne qu\'avec l\'interpréteur bash. La commande sera ajoutée lors de la création du fichier."))
        ...
        self.edt_postinstall.setToolTip(_translate("mw_anaconda", "Inserez ici le chemin vers votre interpréteur"))
        self.lbl_PostInsertion.setText(_translate("mw_anaconda", "Inserez ici la liste vos commandes de post installation."))
        self.ptedt_PostListeCommandes.setPlaceholderText(_translate("mw_anaconda", "Inserez ici vos commandes de post installation sans les balises %post ou % end"))
        self.cb_PostEpel.setToolTip(_translate("mw_anaconda", "Ne fonctionne qu\'avec l\'interpréteur bash et centos 7 ou 8. La commande sera ajoutée lors de la création du fichier."))
        self.cb_PostEpel.setText(_translate("mw_anaconda", "Installer le dépot EPEL."))
        self.cb_PostRpmFusion.setToolTip(_translate("mw_anaconda", "Ne fonctionne qu\'avec l\'interpréteur bash. La commande sera ajoutée lors de la création du fichier."))
        ...
        self.actionpouette.setText(_translate("mw_anaconda", "pouette"))
        self.actionA_propos_de_Qt.setText(_translate("mw_anaconda", "A propos de Qt"))
        self.actionA_propos_de_Qt.setToolTip(_translate("mw_anaconda", "Affiche les information sur la version de Qt utilisée par le programme."))
        self.actionA_propos_de_Qt.setShortcut(_translate("mw_anaconda", "F2"))
